...
class SimpleClassifier2(nn.Module):  # 增加隐藏层
...
class SimpleClassifier3(nn.Module):  # 增加节点数
    def __init__(self, input_dim, hidden_dim, output_dim):
        ...
        self.fc1 = nn.Linear(input_dim, hidden_dim * 2)  # 节点数翻倍
        self.relu = nn.ReLU()
...
class SimpleClassifier4(nn.Module):  # 减少节点数
    def __init__(self, input_dim, hidden_dim, output_dim):
        super(SimpleClassifier4, self).__init__()
        self.fc1 = nn.Linear(input_dim, hidden_dim // 2)  # 节点数减半
        self.relu = nn.ReLU()
        self.fc2 = nn.Linear(hidden_dim // 2, output_dim)
